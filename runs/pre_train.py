...
from utils.checkpoint_util import save_pretrain_checkpoint, save_pretrain_withseg_checkpoint
    ...
    for epoch in range(args.n_iters):
        ...
        if (epoch+1) % args.eval_interval == 0:
            ...
            if mIoU > best_iou:
                ...
                save_pretrain_withseg_checkpoint(model, args.log_dir)
