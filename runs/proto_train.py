...
from dataloaders.loader import MyDataset, MyTestDataset, batch_test_task_collate, batch_obj_task_collate
...
def train(args):
    ...
    TRAIN_LOADER = DataLoader(TRAIN_DATASET, batch_size=1, collate_fn=batch_obj_task_collate)
    VALID_LOADER = DataLoader(VALID_DATASET, batch_size=1, collate_fn=batch_obj_task_collate)
