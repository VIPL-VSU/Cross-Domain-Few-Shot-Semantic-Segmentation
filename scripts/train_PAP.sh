...
# SAVE_PATH='./log_s3dis_PAP_ablation_final/'
...
# SPLIT=1
# DATA_PATH='./datasets/S3DIS/blocks_bs1_s1'
# SAVE_PATH='./log_s3dis_sunrgbd_PAP_ablation/'

# DATASET='scannet'
# SPLIT=1
# DATA_PATH='./datasets/ScanNet/blocks_bs1_s1'
# SAVE_PATH='./log_scannet_PAP_ablation_final/'
...
# SPLIT=1
# DATA_PATH='./datasets/ScanNet/blocks_bs1_s1'
# SAVE_PATH='./log_scannet_sunrgbd_PAP/'
...
# PRETRAIN_CHECKPOINT='./log_s3dis_modelnet/log_pretrain_s3dis_model_S0'
# PRETRAIN_CHECKPOINT='./log_s3dis_sunrgbd/log_pretrain_s3dis_sunrgbd_S0'
# PRETRAIN_CHECKPOINT='./log_scannet/log_pretrain_scannet_S1'
PRETRAIN_CHECKPOINT='./log_scannet_modelnet/log_pretrain_scannet_model_S1'
# PRETRAIN_CHECKPOINT='./log_scannet_sunrgbd/log_pretrain_scannet_sunrgbd_S1'
...
args=(--phase 'prototrain' --dataset "${DATASET}" --cvfold $SPLIT
      ...
      --obj --use_transformer --use_supervise_prototype
