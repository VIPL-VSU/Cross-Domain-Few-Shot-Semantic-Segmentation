...
class S3DISDataset_sunrgbd(object):
    def __init__(self, data_path):
        ...
        class_names = open(os.path.join('./datasets/S3DIS', 'meta', 's3dis_classnames.txt')).readlines()
        ...
        self.novel_classes = [ 'chair', 'door', 'sofa', 'table', 'window']
