...
class ScanNetDataset_ModelNet(object):
    def __init__(self, data_path):
        ...
        model_class_names = ['bathtub', 'bed', 'bookshelf', 'chair', 'curtain', 'desk', 'door', 'sink', 'sofa', 'table', 'toilet']
        self.novel_classes = ['bed', 'chair', 'sofa', 'table']
